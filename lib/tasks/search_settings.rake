namespace :search_settings do
  ...
  task add: :environment do
    ...
    Sures::SearchSetting.find_or_create_by(title: 'Por proyecto', data_type: 'order', data: nil, resource: "Sures::Actuation", field: "project_scope", rules: "asc") 
    ...
    Geozone.all.each do |g|
      districts.merge!({g.name => g.id, "active" => "true"})
    end
