namespace :search_settings do
  ...
  task add: :environment do
    ...
    Sures::SearchSetting.find_or_create_by(title: 'Proyecto', data_type: 'text', data: '{}', resource: "Sures::Actuation", field: "project", rules: nil)
    Sures::SearchSetting.find_or_create_by(title: 'Actuación', data_type: 'text', data: '{}', resource: "Sures::Actuation", field: "actions_taken", rules: nil)
    Sures::SearchSetting.find_or_create_by(title: 'Distrito', data_type: 'select', data: districts.to_s.to_json, resource: "Sures::Actuation", field: "geozones", rules: nil, data_status: districts_status.to_json)
