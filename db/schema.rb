...
ActiveRecord::Schema.define(version: 20210624085951) do
  ...
  create_table "custom_page_modules", force: :cascade do |t|
    ...
    t.integer  "cta_image_file_size"
    t.datetime "cta_image_updated_at"
    t.string   "cta_button"
    ...
    t.string   "list_icon_one_file_name"
    t.string   "list_icon_one_content_type"
    t.integer  "list_icon_one_file_size"
    t.datetime "list_icon_one_updated_at"
    t.string   "list_title_one"
    t.text     "list_description_one"
    t.string   "list_icon_two_file_name"
    t.string   "list_icon_two_content_type"
    t.integer  "list_icon_two_file_size"
    t.datetime "list_icon_two_updated_at"
    t.string   "list_title_two"
    t.text     "list_description_two"
    t.string   "list_icon_three_file_name"
    t.string   "list_icon_three_content_type"
    t.integer  "list_icon_three_file_size"
    t.datetime "list_icon_three_updated_at"
